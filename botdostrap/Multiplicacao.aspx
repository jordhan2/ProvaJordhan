<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Multiplicacao.aspx.cs" Inherits="botdostrap.Multiplicacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form>
     ...
     <asp:Button id="btnMultiplicacao" runat="server" class="btn btn-success" Text="Fazer Operacao - Multiplicacao" OnClick="btnMultiplicacao_Click"  />
     <br />
